package pe.com.fondam.sgp.web.session;

import java.io.Serializable;

public class UserSession implements Serializable {

	private static final long serialVersionUID = -4651501757353830784L;
	...
	public void setPrefijoPerfil(String prefijoPerfil) {
		this.prefijoPerfil = prefijoPerfil;
	}

	public String getPrefijoPerfil() {
		return prefijoPerfil;
	}
