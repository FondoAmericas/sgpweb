		...
		<form:form name="formResultado" method="post" action="" target="_self">
			...
			<fieldset>
				...
				<div class="hide" style="width: 100%; text-align: right;"><input type="button"
									...
									onclick="grabarMarcoLogico()" /> <input type="button"
				...
				<div id="div_indicador">
					<fieldset>
						<legend>INDICADOR DE PROPOSITO</legend>
<div class="hide">
						<table width="100%">
							<tr>
							...
							<tr>
								...
								<td colspan="3" style="text-align: left; width: 75%"><textarea id="txtMetodoCalculo" 
									name="txtMetodoCalculo" COLS="55" ROWS="2"
