...
<div id="div_problemasSoluciones">
	...
	<tr class="<c:out value="${classIdi}"></c:out>">
			...
			<td style="width: 6%; text-align: center;" class="hide"><label>
														<a
														href="javascript:agregarObservacion('<c:out value="${problemaSolucion.problemaSolucionID  }" ></c:out>','<c:out value="${reporteAvance.datoProyecto.datoProyectoID }" ></c:out>','8','20','<c:out value="${reporteAvance.reporteAvanceID}" ></c:out>')"
