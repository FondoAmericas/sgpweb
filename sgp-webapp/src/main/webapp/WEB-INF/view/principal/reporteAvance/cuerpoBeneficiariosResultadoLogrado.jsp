...
<script type="text/javascript">
	...
	function grabarCantidadLograda(){
		$.get("grabarCantidadLograda.jspx", {
			reporteAvanceId : $("#reporteAvanceId").val(),
			cantidadLograda : $("#logrado").val(),
	...
	<div class="form-clasico">
		...
		<fieldset style="padding-left: 10px">
			...
			<input type="hidden" id="reporteAvanceId" name="reporteAvanceId"
				value="${reporteAvanceId }"> <input type="hidden"
			...
			<tr>
				...
				<tr>
					...
					<tr>
						<td style="width: 25%; text-align: right;  vertical-align: top;"><label>Cantidad Lograda:</label>
						</td>
						<td style="width: 25%; text-align: left;  vertical-align: top;">
