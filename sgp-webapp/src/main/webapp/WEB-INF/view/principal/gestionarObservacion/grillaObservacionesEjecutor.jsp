...
<table border="0" width="100%" class="table-clasico">
	...
	<thead>
		<tr>
			...
			<td style="width: 5%; text-align: center;"><label style="font-size: 10px;">Levantar</label></td>
	...
	<tr class="<c:out value="${classIdi}"></c:out>">
			...
			<td style="width: 10%;text-align: left;"><label><c:out value="${observacion.descripcionEstado }"></c:out></label></td>
			...
			<td style="width: 15%;text-align: left;"><label>
			<c:choose>
				<c:when test="${observacion.flagEstado == '-1' }"><a href="javascript:levantarObservacion('${observacion.observacionID }','${observacion.descripcion }','${observacion.fkIdtablaespTipoObservacion }','${observacion.fechaObservacionString }','${observacion.tablaClase.tableclaseID }','${observacion.relevanteProyecto }','${observacion.descripcionEjecutor }');"
												id="levantarObservacion" class="linkSelecciona">Levantar<br>Observacion</a></c:when>
		...
		<tr class="<c:out value="${classIdi}"></c:out>">
				<td colspan="100%">
					<div
						...
						<table width="96%">
							<tr>
								<td style="width: 25%; font-weight: bold; text-align:right; "><label>Descripcion Ejecutor:</label></td>
								<td style="width: 75%; text-align:left;"><label><c:out value="${observacion.descripcionEjecutor }"></c:out></label></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width: 25%; font-weight: bold; text-align:right;"><label>Fecha Atendido por Ejecutor:</label></td>
								<td style="width: 75%; text-align:left;"><label><c:out value="${observacion.fechaAtencionObservacionString }"></c:out> (dd/mm/aaaa)</label></td>
							</tr>
							<tr>
								<td style="width: 25%; font-weight: bold; text-align:right;"><label>Fecha Aprobado por Fondam:</label></td>
								<td style="width: 75%; text-align:left;"><label><c:out value="${observacion.fechaLevantamientoObservacionString }"></c:out> (dd/mm/aaaa)</label></td>
							</tr>
						</table>
					</div>
				</td>
