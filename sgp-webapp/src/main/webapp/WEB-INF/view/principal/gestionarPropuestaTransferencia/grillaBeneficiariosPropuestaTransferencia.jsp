	...
	<thead>
		<tr>
			...
			<td style="width: 10%; text-align: center;" class="hide"><label
				style="font-size: 10px;" >Ingresar<br>Cantidad
					<br>Lograda</label>
			</td>
		</tr>
	</thead>
	<tbody>
		...
		<c:forEach items="${listBeneficiariosPorResultadoBean }"
			...
			<tr class="<c:out value="${classIdi}"></c:out>">
				...
				<td style="width: 10%; text-align: center;" class="hide"><label>
						<a
						href="javascript:agregarCantidadLograda('<c:out value="${beneficiariosPorResultadoBean.beneficiariosPorResultadoID }"></c:out>');"
