		...
		<c:forEach items="${listBien }" var="bien" varStatus="indice">
			...
			<tr class="<c:out value="${classIdi}"></c:out>">
				<td style="width: 5%; text-align: center;"><a
					href="javascript:expandcollapse('divB2<c:out value="${bien.bienID }"></c:out>', 'one');">
						<img id='imgdivB2<c:out value="${bien.bienID}"></c:out>' border="0"
			...
			<a	href="javascript:agregarObservacion('<c:out value="${bien.bienID }" ></c:out>','<c:out value="${datoProyectoId }" ></c:out>','10','45','<c:out value="${informeFinalId }" ></c:out>')"
							class="linkSelecciona">Observacion</a></label><br>
				</td>
			</tr>
			<tr class="<c:out value="${classIdi}"></c:out>">
				<td colspan="100%">
					<div id='divB2<c:out value="${bien.bienID }"></c:out>'
