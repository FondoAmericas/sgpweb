...
<table border="0" width="100%" class="table-clasico">
	...
	<tr class="<c:out value="${classIdi}"></c:out>">
			...
			<a	href="javascript:agregarObservacion('<c:out value="${organizacion.organizacionID }" ></c:out>','<c:out value="${datoProyectoId }" ></c:out>','11','36','<c:out value="${propuestaTransferenciaId }" ></c:out>')"
