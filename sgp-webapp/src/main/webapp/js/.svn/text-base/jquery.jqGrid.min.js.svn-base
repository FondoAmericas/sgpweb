					...
					b.jgrid,
					{
						...
						stringToDoc : function(f) {
							...
							if (typeof f !== "string")
								return f;
							try {
								j = (new DOMParser).parseFromString(f,
										"text/xml")
							} catch (i) {
							...
							return j
									&& j.documentElement
									&& j.documentElement.tagName != "parsererror" ? j
									: null
						},
						parse : function(f) {
							f = f;
						...
						parseDate : function(f, j) {
							...
							if (j && j !== null && j !== undefined) {
								...
								for (e = f.length; c < e; c++) {
									...
									if (j[c] !== undefined)
										i[f[c].toLowerCase()] = parseInt(j[c],
												10)
								}
						...
						from : function(f) {
							return new (function(j, i) {
								...
								this._getOrder = function(l, m, q, A, u) {
									...
									aa = A == "float" || A == "number"
										...
										return isNaN(L) ? 0 : L
											...
											: A == "int" || A == "integer" ? function(
													L) {
												return L ? parseFloat(String(L)
														.replace(r, "")) : 0
											}
													: A == "date"
															|| A == "datetime" ? function(
								...
								this._compareValues = function(l, m, q, A, u) {
									...
									case "date":
									case "datetime":
										q = String(b.jgrid.parseDate(
												u.newfmt || "Y-m-d", q)
												.getTime());
										I = 'jQuery.jgrid.parseDate("'
												+ u.srcfmt + '",' + I
												+ ").getTime()";
										break;
									default:
								...
								this.equals = function(l, m, q) {
									return c._compareValues(c.equals, l, m,
											"==", q)
								};
								this.greater = function(l, m, q) {
									return c._compareValues(c.greater, l, m,
											">", q)
								};
								this.less = function(l, m, q) {
									return c._compareValues(c.less, l, m, "<",
											q)
								};
								...
								this.lessOrEquals = function(l, m, q) {
									return c._compareValues(c.lessOrEquals, l,
											m, "<=", q)
								};
								this.startsWith = function(l, m) {
									var q = m === undefined || m === null ? l
											: m;
									q = n ? b.trim(q.toString()).length : q
											.toString().length;
									if (N)
										c._append(c._getStr("this." + l)
												+ ".substr(0,"
												+ q
												+ ") == "
										...
										q = n ? b.trim(m.toString()).length : m
												.toString().length;
								...
								this.orderBy = function(l, m, q, A) {
									m = m === undefined || m === null ? "a" : b
											.trim(m.toString().toLowerCase());
					...
					if (!this.grid) {
						var c = b.extend(true, {
							...
							dragStart : function(d, g, h) {
								...
								this.curGbox = b("#rs_m" + c.id, "#gbox_"
										+ c.id);
								this.curGbox.css({
									display : "block",
									left : h[0],
							...
							dragMove : function(d) {
								if (this.resizing) {
									...
									var h = c.direction === "ltr" ? d.width + g
											: d.width - g, o;
									if (h > 33) {
										this.curGbox.css({
								...
								if (this.resizing) {
									...
									if (c.forceFit === true) {
										...
										this.headers[d + c.nv].el.style.width = g
												+ "px";
										this.cols[d + c.nv].style.width = g
												+ "px";
										if (this.footers.length > 0)
						...
						if (this.tagName != "TABLE")
							...
							if (this.p.colNames.length !== this.p.colModel.length)
								...
								var t = b("<div class='ui-jqgrid-view'></div>"), B, F = b.browser.msie ? true
										: false, S = b.browser.safari ? true
										: false;
								a = this;
								...
								var N = function(d, g) {
									...
									h = (parseInt(h, 10) - 1) * parseInt(o, 10)
											+ 1 + g;
									...
									g = a.p.keyIndex === false
											|| a.p.loadonce === true ? a.p.localReader.id
											: a.p.colModel[a.p.keyIndex + h + o
													+ g].name;
									for (h = 0; h < d; h++) {
									...
									var x = new Date, w = a.p.datatype != "local"
											&& a.p.loadonce
											|| a.p.datatype == "xmlstring", C, G = a.p.datatype == "local" ? "local"
											: "xml";
									if (w) {
										a.p.data = [];
										a.p._index = {};
									...
									if (b.isXMLDoc(d)) {
										...
										Q = a.p.keyIndex === false ? a.p.xmlReader.id
												: a.p.keyIndex;
										...
										G = (Q + "").indexOf("[") === -1 ? z.length ? function(
												ca, Y) {
											return b(Q, ca).text() || Y
												...
												: function(ca, Y) {
													return ca.getAttribute(Q
															.replace(/[\[\]]/g,
																	""))
															|| Y
												};
										a.p.userData = {};
										b(a.p.xmlReader.page, d).each(
												function() {
													a.p.page = this.textContent
															|| this.text || 0
												});
										b(a.p.xmlReader.total, d)
												.each(
														function() {
										...
										b(a.p.xmlReader.records, d)
												.each(
														function() {
															a.p.records = this.textContent
																	|| this.text
																	|| 0
														});
										b(a.p.xmlReader.userdata, d)
												.each(
														function() {
															a.p.userData[this
																	.getAttribute("name")] = this.textContent
																	|| this.text
														});
										...
										var fa = d.length, Z = 0;
										if (d && fa) {
											var ga = parseInt(a.p.rowNum, 10), qa = a.p.scroll ? (parseInt(
													a.p.page, 10) - 1)
													* ga + 1
													: 1;
											if (p)
											...
											for (; Z < fa;) {
												...
												if (a.p.gridview === false) {
													if (a.p.treeGrid === true) {
														s = a.p.treeANode > -1 ? a.p.treeANode
																: 0;
														D = b(X.join(""))[0];
														b(a.rows[Z + s]).after(
																D);
									...
									if (d) {
										...
										W = T.length;
										d = 0;
										var na = parseInt(a.p.rowNum, 10), fa = a.p.scroll ? (parseInt(
												a.p.page, 10) - 1)
												* na + 1
												: 1;
										if (p)
											na *= p + 1;
										var Z = b
												.isFunction(a.p.afterInsertRow), ga = {}, qa = "";
										if (a.p.grouping
												&& a.p.groupingView.groupCollapse === true)
									...
									if (b.isArray(a.p.data)) {
										var G = a.p.grouping ? a.p.groupingView
												: false;
										b
												.each(
														a.p.colModel,
										...
										if (a.p.treeGrid)
											b(a).jqGrid("SortTree", d,
													a.p.sortorder, h[d].stype,
													h[d].srcfmt);
										else {
											var s = {
												eq : function(z) {
											...
											if (d && a.p.sortorder && g)
												a.p.sortorder.toUpperCase() == "DESC" ? v
								...
								B = function(d, g) {
									...
									if (a.p.pgbuttons === true) {
										...
										o += h !== "" ? "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>"
												+ h
									...
									o = b(o).clone().appendTo("#testpg")
											.width();
									b("#testpg").remove();
									if (o > 0) {
										if (h != "")
											o += 50;
										b("td#" + d + "_" + a.p.pagerpos,
												"#" + x).width(o)
									}
									a.p._nvtd = [];
									a.p._nvtd[0] = o ? Math
											.floor((a.p.width - o) / 2) : Math
											.floor(a.p.width / 3);
									a.p._nvtd[1] = 0;
									o = null;
									b(".ui-pg-selbox", "#" + x)
									...
									if (a.p.colModel[g].sortable)
										if (!(a.p.savedRow.length > 0)) {
											...
											b(
													...
													h).addClass(
													"ui-state-disabled");
											b("tr th:eq(" + a.p.lastsort + ")",
													h).attr("aria-selected",
													"false");
											b(
													"tr th:eq(" + g
															+ ") span.ui-icon-"
											...
											d = d.substring(5);
											a.p.sortname = a.p.colModel[g].index
													|| d;
											h = a.p.sortorder;
											if (b.isFunction(a.p.onSortCol))
												if (a.p.onSortCol.call(a, d, g,
														h) == "stop") {
													a.p.lastsort = g;
													return
												}
								...
								for (k = 0; k < this.p.colNames.length; k++) {
									...
									r += "<th id='"
											...
											+ n + "'" + la + ">";
									la = a.p.colModel[k].index
											|| a.p.colModel[k].name;
									r += "<div id='jqgh_"
											+ a.p.colModel[k].name + "' " + Da
											+ ">" + a.p.colNames[k];
								...
								b(J).css("width", e.width + "px").append(
								...
								t = b(
										...
										.append(r);
								var ba = a.p.caption && a.p.hiddengrid === true ? true
										: false;
								...
								b(".ui-jqgrid-labels", e.hDiv).bind(
	...
	b.jgrid
			.extend({
				getGridParam : function(f) {
					var j = this[0];
					if (j && j.grid)
						return f ? typeof j.p[f] != "undefined" ? j.p[f] : null
								: j.p
				},
					...
					return this
							.each(function() {
								...
								if (f.p.multiselect) {
									...
									b("#cb_" + b.jgrid.jqID(f.p.id)).attr(
											"checked", false);
									f.p.selarrrow = []
								} else if (f.p.selrow) {
									b(
											"#" + f.p.id + " tbody:first tr#"
					...
					if (j) {
						...
						this
								.each(function() {
									...
									m = u.p.altclass;
									for ( var U = 0, $ = "", P = {}, aa = b
											.isFunction(u.p.afterInsertRow) ? true
											: false; U < I;) {
										q = j[U];
										n = "";
										if (N) {
										...
										if (u.rows.length === 0)
											b("table:first", u.grid.bDiv)
													.append(n);
										else
											switch (i) {
											case "last":
												b(u.rows[u.rows.length - 1])
														.after(n);
												break;
											case "first":
												b(u.rows[0]).after(n);
					...
					return this
							.each(function() {
								...
								if (i.grid) {
									...
									if (c === true) {
										b("table:first", i.grid.hDiv).width(
												i.p.tblwidth);
										b("table:first", i.grid.bDiv).width(
												i.p.tblwidth);
										i.grid.hDiv.scrollLeft = i.grid.bDiv.scrollLeft;
										if (i.p.footerrow) {
											b("table:first", i.grid.sDiv)
													.width(i.p.tblwidth);
							...
							.each(function() {
								if (this.grid) {
									...
									if (!isNaN(f)) {
										...
										b("#gbox_" + i.p.id).css("width",
												f + "px");
										b("#gview_" + i.p.id).css("width",
												f + "px");
										b(i.grid.bDiv).css("width", f + "px");
										b(i.grid.hDiv).css("width", f + "px");
										i.p.pager
												&& b(i.p.pager).css("width",
														f + "px");
										i.p.toppager
												&& b(i.p.toppager).css("width",
														f + "px");
										if (i.p.toolbar[0] === true) {
											b(i.grid.uDiv).css("width",
													f + "px");
											i.p.toolbar[1] == "both"
													&& b(i.grid.ubDiv).css(
															"width", f + "px")
											...
											if (a !== 0) {
												...
												if (r) {
													if (f - F - (e + k * a) !== t)
														N = f - F - (e + k * a)
																- t
												} else if (Math.abs(f - F
														- (e + k * a)) !== 1)
													N = f - F - (e + k * a);
												i.p.colModel[n].width += N;
												i.p.tblwidth = e + N + S + k
														* J;
												if (i.p.tblwidth > f) {
													r = i.p.tblwidth
															- parseInt(f, 10);
												...
												i.grid.headers[n].el.style.width = c
														+ "px";
												if (l)
													i.grid.cols[n].style.width = c
															+ "px";
												b("table:first", i.grid.bDiv)
														.css(
																"width",
																i.p.tblwidth
																		+ "px");
												b("table:first", i.grid.hDiv)
														.css(
																"width",
																i.p.tblwidth
																		+ "px");
												i.grid.hDiv.scrollLeft = i.grid.bDiv.scrollLeft;
												if (i.p.footerrow) {
													i.grid.footers[n].style.width = c
															+ "px";
													b("table:first",
															i.grid.sDiv)
															.css(
					...
					return this.each(function() {
						...
						if (e.grid) {
							...
							if (k >= 0) {
								...
								if (j) {
									var a = b(".s-ico", n);
									b("[id^=jqgh_]", n).empty().html(j).append(
											a);
									e.p.colNames[k] = j
								}
								if (i)
									typeof i === "string" ? b(n).addClass(i)
											: b(n).css(i);
...
(function(c) {
	...
	c.fmatter.util = {
		NumberFormat : function(a, b) {
			...
			if (c.fmatter.isNumber(a)) {
				var d = a < 0, f = a + "", e = b.decimalSeparator ? b.decimalSeparator
						: ".";
		...
		DateFormat : function(a, b, d, f) {
			...
			var l = h.getSeconds(), o = h.getMilliseconds(), n = h.getDay(), p = h
				...
				I : "?",
				O : (j > 0 ? "-" : "+")
						+ i(Math.floor(Math.abs(j) / 60) * 100 + Math.abs(j)
								% 60, 4),
				P : "?",
				T : (String(h)
						.match(
	...
	c.fn.fmatter.rowactions = function(a, b, d, f) {
		...
		case "edit":
			...
			break;
		case "save":
			c("#" + b).jqGrid("saveRow", a, e.onSuccess, e.url, e.extraparam,
					f, e.onError, i);
			c(
					"tr#" + a + " div.ui-inline-edit, tr#" + a
							+ " div.ui-inline-del", "#" + b).show();
								...
								if (this.grid) {
									...
									if (f == "hidden") {
										a(".ui-jqgrid-bdiv, .ui-jqgrid-hdiv",
												"#gview_" + d.p.id).slideUp(
												"fast");
										d.p.pager
												&& a(d.p.pager).slideUp("fast");
										d.p.toppager
												&& a(d.p.toppager).slideUp(
														"fast");
										if (d.p.toolbar[0] === true) {
											d.p.toolbar[1] == "both"
													&& a(d.grid.ubDiv).slideUp(
															"fast");
										...
										a(".ui-jqgrid-hdiv, .ui-jqgrid-bdiv",
												"#gview_" + d.p.id).slideDown(
												"fast");
										d.p.pager
												&& a(d.p.pager).slideDown(
														"fast");
										d.p.toppager
												&& a(d.p.toppager).slideDown(
														"fast");
										if (d.p.toolbar[0] === true) {
											d.p.toolbar[1] == "both"
													&& a(d.grid.ubDiv)
					...
					return this
							.each(function() {
								...
								if (this.p.filterModel.length === 0
									...
									this.p.gridid = f.indexOf("#") != -1 ? f
											: "#" + f;
									var m = a(this.p.gridid).jqGrid(
					...
					return this
							.each(function() {
								...
								var b = this, m = function() {
									...
									if (f.stringResult === true
											|| b.p.datatype == "local") {
										var i = '{"groupOp":"' + f.groupOp
												+ '","rules":[', j = 0;
								...
								this.clearToolbar = function(h) {
									...
									a.isFunction(f.afterClear)
											&& f.afterClear()
								};
								this.toggleToolbar = function() {
									var h = a("tr.ui-search-toolbar",
											b.grid.hDiv);
									h.css("display") == "none" ? h.show() : h
											.hide()
								}
							})
				}
			...
			.extend(
					a.jgrid,
					{
						...
						createModal : function(b, c, d, f, g, h) {
							...
							if (i) {
								e.dir = "rtl";
								a(".ui-jqdialog-title", j)
										.css("float", "right");
								a(".ui-jqdialog-titlebar-close", j).css("left",
										"0.3em")
							} else {
								e.dir = "ltr";
								a(".ui-jqdialog-title", j).css("float", "left");
								a(".ui-jqdialog-titlebar-close", j).css(
										"right", "0.3em")
							}
							...
							a("a.ui-jqdialog-titlebar-close", j).click(
									function() {
										var l = a("#" + b.themodal).data(
												"onClose")
												|| d.onClose, o = a(
							...
							if (d.height === 0 || !d.height)
								d.height = 200;
							if (!d.zIndex) {
								f = a(f).parents("*[role=dialog]").first().css(
										"z-index");
						...
						info_dialog : function(b, c, d, f) {
							...
							i += "<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:"
									...
									+ ("text-align:" + g.align + ";")
									+ "'>" + c + "</div>";
							i += d ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:"
									+ g.buttonalign
							...
							function h(l, o) {
								...
								if (o.dataEvents) {
									a.each(o.dataEvents, function() {
										this.data !== undefined ? a(l).bind(
												this.type, this.data, this.fn)
												: a(l).bind(this.type, this.fn)
									});
									delete o.dataEvents
								}
								return o
							...
							case "custom":
								...
								try {
									if (a.isFunction(c.custom_element)) {
										var q = c.custom_element.call(this, d,
												c);
										if (q) {
											q = a(q).addClass("customelement")
													.attr({
														id : c.id,
														name : c.name
													});
						...
						checkDate : function(b, c) {
							...
							if (e === -1)
								...
								j = f[b[e]].toString();
								if (j.length < 1 || f[b[e]] < 1 || f[b[e]] > 31
										|| f[b[i]] == 2 && f[b[e]] > d(f[b[g]])
										|| f[b[e]] > n[f[b[i]]])
									return false
							}
							return true
				...
				searchGrid : function(e) {
					...
					return this
							.each(function() {
								...
								function z(l) {
									l = l && l.hasOwnProperty("reload") ? l.reload
											: true;
									var u = a("#" + w.p.id), t = {};
									u[0].p.search = false;
									if (e.multipleSearch === false)
								...
								if (w.grid) {
									...
									if (a.fn.searchFilter) {
										e.recreateFilter === true
												&& a("#" + o).remove();
										if (a("#" + o).html() != null) {
											if (a
													.isFunction(e.beforeShowSearch)) {
												m = e.beforeShowSearch(a("#"
														+ o));
											...
											a
													.each(
															d,
															function(l, u) {
																var t = typeof u.search === "undefined" ? true
											...
											if (r.length > 0) {
												...
												e.multipleSearch === true
														...
														&& b(w, e);
												a
														.isFunction(e.onInitializeSearch)
														&& e
																.onInitializeSearch(a("#"
																		+ o));
												if (a
														.isFunction(e.beforeShowSearch)) {
													m = e
							...
							.each(function() {
													...
													function(U) {
														...
														if (G !== "cb"
															...
															a(
																	...
																	C[0])
																	.html(
																			typeof X.label === "undefined" ? n.p.colNames[U]
																					: X.label);
															a(
																	"td:eq("
																			+ (ea - 1)
								...
								function z() {
									...
									if (n[0] && !c.processing) {
										...
										B = s.oper;
										G = s.id;
										f[B] = a.trim(f[d.p.id + "_id"]) == "_empty" ? s.addoper
												: s.editoper;
										if (f[B] != s.addoper)
											f[G] = f[d.p.id + "_id"];
												...
												.extend(
														{
															...
															type : c.mtype,
															data : a
																	.isFunction(c.serializeEditData) ? c
																	.serializeEditData(f)
																	: f,
															complete : function(
																	A, M) {
																if (M != "success") {
																	n[0] = false;
																	n[1] = a
																			.isFunction(c.errorTextFormat) ? c
																			.errorTextFormat(A)
																			: M
																					+ " Status: '"
																					+ A.statusText
										...
										if (n[0])
											c.useDataProxy ? d.p.dataProxy
													.call(d, x, "set_" + d.p.id)
													: a.ajax(x)
									}
									if (n[0] === false) {
								...
								function v() {
									var g = a(d).jqGrid("getDataIDs"), n = a(
											"#id_g", "#" + j).val();
									return [ a.inArray(n, g), g ]
								}
								var d = this;
								if (d.grid && e) {
									var q = d.p.id, h = "FrmGrid_" + q, j = "TblGrid_"
											+ q, k = {
										themodal : "editmod" + q,
										modalhead : "edithd" + q,
										modalcontent : "editcnt" + q,
										scrollelm : h
									}, E = a.isFunction(c.beforeShowForm) ? c.beforeShowForm
											: false, P = a
											.isFunction(c.afterShowForm) ? c.afterShowForm
											: false, l = a
											.isFunction(c.beforeInitData) ? c.beforeInitData
											: false, u = a
											.isFunction(c.onInitializeForm) ? c.onInitializeForm
									...
									if (a("#" + k.themodal).html() != null) {
										...
										K = a("<span></span>").append(K)
												.append(t);
										a.jgrid.createModal(k, K, b, "#gview_"
												+ d.p.id,
												a("#gbox_" + d.p.id)[0]);
										if (l) {
											a("#pData, #nData", "#" + j + "_2")
				...
				viewGridRow : function(e, b) {
					...
					return this
							.each(function() {
													...
													function(A) {
														...
														Z = (T = this.editrules
																...
																: this.hidden === true ? true
																		: false) ? "style='display:none'"
																: "";
														C = typeof this.viewable != "boolean" ? true
																: this.viewable;
														if (O !== "cb"
																&& O !== "subgrid"
																&& O !== "rn"
															...
															a(
																	...
																	.html(
																			"<b>"
																					+ (typeof M.label === "undefined" ? f.p.colNames[A]
																							: M.label)
																					+ "</b>");
															a(
																	"td:eq("
												...
												.each(
														function(N) {
															...
															R = f.p.colModel[N].editrules
																	&& f.p.colModel[N].editrules.edithidden === true ? false
																	: f.p.colModel[N].hidden === true ? true
																			: false;
															if (J !== "cb"
																	&& J !== "subgrid"
																	&& J !== "rn") {
								...
								function w() {
									var i = a(o).jqGrid("getDataIDs"), f = a(
											"#id_g", "#" + v).val();
								...
								if (o.grid && e) {
									...
									var m = o.p.id, r = "ViewGrid_" + m, v = "ViewTbl_"
											+ m, d = {
										themodal : "viewmod" + m,
										modalhead : "viewhd" + m,
										modalcontent : "viewcnt" + m,
										scrollelm : r
									}, q = a.isFunction(b.beforeInitData) ? b.beforeInitData
									...
									if (a("#" + d.themodal).html() != null) {
										...
										var E = isNaN(b.dataheight) ? b.dataheight
												: b.dataheight + "px";
										...
										E = a("<span></span>")
												...
												.append(
														"<table border='0' class='EditTable' id='"
																...
																+ u
																+ "</td></tr></tbody></table>");
										a.jgrid.createModal(d, E, b, "#gview_"
												+ o.p.id,
												a("#gview_" + o.p.id)[0]);
										if (q) {
											a("#pData, #nData", "#" + v + "_2")
				...
				delGridRow : function(e, b) {
					...
					return this
							.each(function() {
								...
								if (p.grid)
									if (e) {
										var F = typeof b.beforeShowForm === "function" ? true
												: false, y = typeof b.afterShowForm === "function" ? true
												: false, z = a
												.isFunction(b.beforeInitData) ? b.beforeInitData
										...
										if (a("#" + j.themodal).html() != null) {
											...
											if (m === false)
												return;
											z = isNaN(b.dataheight) ? b.dataheight
													: b.dataheight + "px";
											z = "<div id='"
													+ r
					...
					return this
							.each(function() {
								if (this.grid) {
									...
									if (p) {
										var y = a("<td></td>");
										b.buttonicon.toString().toUpperCase() == "NONE" ? a(
												y).addClass(
										...
										if (b.position == "first")
											p.rows[0].cells.length === 0 ? a(
													"tr", p).append(y) : a(
													"tr td:eq(0)", p).before(y);
										else
											a("tr", p).append(y);
										a(y, p)
												.attr("title", b.title || "")
	...
	function I(e, l, v) {
		...
		if (l != null) {
													...
													.extend(
															{
																...
																complete : function(
																	...
																	a == n
																			&& e
																					.find(
																							"tr.sf td.fields select[name='field']")
																					.change()
																}
															},
															f.ajaxSelectOptions))
					...
					.click(
							function(a) {
								...
								if (f.clone) {
									...
									if (d[0] != null)
										d[0].selectedIndex = a
												.find("select.vdata")[0].selectedIndex
								} else {
					...
					.click(
							function() {
								var a = jQuery(e.selector), b, d = a.find(
										"select[name='groupOp'] :selected")
										.val();
								b = f.stringResult ? '{"groupOp":"' + d
										+ '","rules":[' : {
									groupOp : d,
									rules : []
								};
										...
										.each(
												function(c) {
													var g = jQuery(this)
															...
															this)
															.find(
																	"select[name='op'] :selected")
															.val(), h = jQuery(
															this)
															.find(
																	"input.vdata,select.vdata :selected")
															.val();
													h += "";
													h = h
															.replace(/\\/g,
			...
			e.find(".ui-add-last").click(
					function() {
						var a = jQuery(e.selector + " .sf:last"), b = a.clone(
								true).insertAfter(a);
						b.find(".ui-state-default").removeClass(
								"ui-state-hover ui-state-active");
						b.find(".data input").val("");
							...
							.each(function() {
								...
								if (!(!c.grid || c.p.cellEdit !== true)) {
									...
									if (!(h == "subgrid" || h == "cb" || h == "rn")) {
										...
										if (c.p.colModel[e].editable === true
												&& a === true
												&& !g
								...
								if (!(!a.grid || a.p.cellEdit !== true)) {
									...
									if (c !== null) {
										...
										case "checkbox":
											var n = [ "Yes", "No" ];
											if (k.editoptions)
												n = k.editoptions.value
														.split(":");
											g = f = b("#" + d + "_" + i,
													a.rows[d]).attr("checked") ? n[0]
													: n[1];
											break;
										case "password":
										case "text":
				...
				if (!this[c]) {
					...
					b(this).click(function() {
						for ( var h in {
							...
							for ( var g in this[h])
								i[this[h][g]] && i[this[h][g]].w[h](this);
						return e
					})
				}
				this[c].push(d)
			...
			.extend({
				...
				addSubGridCell : function(e, c) {
					...
					return n === false ? '<td role="grid" aria-describedby="'
							...
							: '<td role="grid" aria-describedby="' + o
									+ '_subgrid" ' + a + "></td>"
				},
								...
								if (a.grid) {
									var n = function(g, j, f) {
										...
										for (d = 0; d < a.p.subGridModel[0].name.length; d++) {
											...
											b(f)
													.html(
															a.p.subGridModel[0].name[d]);
											b(f)
													.width(
															a.p.subGridModel[0].width[d]);
											b(k).append(f)
										}
										b(i).append(k);
										if (g) {
										...
										g = b("table:first", a.grid.bDiv).attr(
												"id")
												+ "_";
										b("#" + g + j).append(i);
										a.grid.hDiv.loading = false;
										...
										d = b("table:first", a.grid.bDiv).attr(
												"id")
												+ "_";
										b("#" + d + j).append(k);
										a.grid.hDiv.loading = false;
	...
	f.jgrid
			.extend({
					...
					this
							.each(function() {
								...
								if (a.hasOwnProperty(e))
									...
									g.sortnames[0]
											.push(f.trim(b[0].toString()));
									g.summaryval[0][e] = f.extend(true, [],
											g.summary[0])
								}
								g.groupSummary[0]
										&& f
				...
				groupingToggle : function(c) {
					this
							.each(function() {
								var b = this.p.groupingView, a = c
										.lastIndexOf("_"), d = c.substring(0,
										a + 1);
								...
								if (f("#" + c + " span").hasClass(e)) {
									b.showSummaryOnHide && b.groupSummary[0] ? f(
											...
											: f("#" + c).nextUntil(
													"#" + d + String(a)).hide();
									f("#" + c + " span").removeClass(e)
											.addClass(g)
								} else {
									f("#" + c).nextUntil("#" + d + String(a))
											.show();
									f("#" + c + " span").removeClass(g)
											.addClass(e)
								}
							});
					return false
					...
					return this
							.each(function() {
								...
								if (a.grid && a.p.treeGrid) {
									...
									g = "<div class='tree-wrap tree-wrap-"
											+ a.p.direction + "' style='width:"
											+ g * 18 + "px;'>";
									g += "<div style='"
											+ (a.p.direction == "rtl" ? "right:"
													: "left:") + j * 18
											+ "px;' class='ui-icon ";
									if (b[l] != undefined)
										b[l] = b[l] == "true" || b[l] === true ? true
												: false;
									if (b[k] == "true" || b[k] === true) {
										...
										if (b[e] == "true" || b[e] === true) {
											g += a.p.treeIcons.minus
													+ " tree-minus treeclick'";
											b[e] = true
										} else {
											g += a.p.treeIcons.plus
													+ " tree-plus treeclick'";
											b[e] = false
										}
										b[k] = false
									...
									if (parseInt(b[i], 10) !== parseInt(
											a.p.tree_root_level, 10))
										d(a).jqGrid("isVisibleNode", b)
												|| d(c).css("display", "none");
									d("td:eq(" + f + ")", c).wrapInner(
											"<span></span>").prepend(g);
									d(".treeclick", c)
											.bind(
													"click",
								...
								if (a.grid && a.p.treeGrid)
									...
									case "nested":
										var f = a.p.treeReader.left_field, e = a.p.treeReader.right_field, k = a.p.treeReader.level_field, i = parseInt(
												b[f], 10), l = parseInt(b[e],
												10), g = parseInt(b[k], 10);
										d(this.p.data)
												.each(
														function() {
															if (parseInt(
								...
								if (a.grid && a.p.treeGrid)
									...
									case "nested":
										var e = a.p.treeReader.left_field, k = a.p.treeReader.right_field, i = a.p.treeReader.level_field, l = parseInt(
												b[e], 10), g = parseInt(b[k],
												10), j = parseInt(b[i], 10);
										d(this.p.data)
												.each(
														function() {
															parseInt(this[i],
					...
					return this
							.each(function() {
								if (this.grid && this.p.treeGrid) {
									...
									if (!b[c]) {
										var a = d.jgrid.getAccessor(b,
												this.p.localReader.id), f = d(
				...
				setColumns : function(a) {
					...
					return this
							.each(function() {
								var c = this;
								if (c.grid) {
									var j = typeof a.beforeShowForm === "function" ? true
											: false, k = typeof a.afterShowForm === "function" ? true
											: false, l = typeof a.afterSubmitForm === "function" ? true
											: false, e = c.p.id, d = "ColTbl_"
											+ e, f = {
										themodal : "colmod" + e,
										modalhead : "colhd" + e,
									...
									if (b("#" + f.themodal).html() != null) {
										...
										var g = isNaN(a.dataheight) ? a.dataheight
												: a.dataheight + "px";
										g = "<div id='"
												+ d
												+ "' class='formdata' style='width:100%;overflow:auto;position:relative;height:"
										...
										g += "<table border='0' class='EditTable' id='"
												...
												+ "</td></tr></tbody></table>";
										a.gbox = "#gbox_" + e;
										b.jgrid.createModal(f, g, a, "#gview_"
												+ c.p.id,
												b("#gview_" + c.p.id)[0]);
	...
	a.jgrid
			.extend({
							...
							.each(function() {
								...
								var c = this, h = {
									...
									update : function(e, g) {
										...
										var l = [];
										e.each(function() {
											var m = a(">div", this).get(0).id
													.replace(/^jqgh_/, "");
											m in i && l.push(i[m])
										});
										a(c).jqGrid("remapColumns", l, true,
												true);
				...
				columnChooser : function(b) {
					function j(f, k, p) {
						if (k >= 0) {
							var o = f.slice(), r = o.splice(k, Math.max(
									f.length - k, k));
							if (k > f.length)
								k = f.length;
							o[k] = p;
					...
					function c(f, k) {
						if (f)
							if (typeof f == "string")
								a.fn[f]
										&& a.fn[f].apply(k, a.makeArray(
												arguments).slice(2));
							else
								a.isFunction(f)
										&& f.apply(k, a.makeArray(arguments)
												.slice(2))
					}
					var h = this;
					if (!a("#colchooser_" + h[0].p.id).length) {
						...
						var g = h.jqGrid("getGridParam", "colModel"), i = h
								.jqGrid("getGridParam", "colNames"), l = {}, m = [];
						e.empty();
						a.each(g, function(f) {
							l[this.name] = f;
							if (this.hidedlg)
						...
						var n = a.isFunction(b.dlog_opts) ? b.dlog_opts.call(h,
								b) : b.dlog_opts;
						c(b.dlog, d, n);
						n = a.isFunction(b.msel_opts) ? b.msel_opts.call(h, b)
								: b.msel_opts;
						c(b.msel, e, n)
					}
				},
							...
							.each(function() {
								...
								if (j.grid && a.fn.resizable) {
									...
									b.stop = function(c, h) {
										...
										a(j).jqGrid("setGridWidth",
												h.size.width, b.shrinkToFit);
