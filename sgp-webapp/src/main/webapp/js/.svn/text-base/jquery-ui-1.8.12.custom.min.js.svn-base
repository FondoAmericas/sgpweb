					...
					"ui.mouse",
					{
						...
						_mouseDown : function(a) {
							...
							if (!a.originalEvent.mouseHandled) {
								...
								var c = this, e = a.which == 1, f = typeof this.options.cancel == "string" ? b(
								...
								true === b.data(a.target, this.widgetName
										+ ".preventClickEvent")
										&& b.removeData(a.target,
												this.widgetName
														+ ".preventClickEvent");
						...
						_mouseUp : function(a) {
							...
							if (this._mouseStarted) {
								...
								a.target == this._mouseDownEvent.target
										&& b.data(a.target, this.widgetName
						...
						refreshPositions : function(a) {
							...
							for ( var b = this.items.length - 1; b >= 0; b--) {
								...
								if (!(c.instance != this.currentContainer
										&& this.currentContainer && c.item[0] != this.currentItem[0])) {
									var e = this.options.toleranceElement ? d(
					...
					"ui.autocomplete",
					{
						...
						_suggest : function(a) {
							...
							this.options.autoFocus
									&& this.menu.next(new d.Event("mouseover"))
						},
					...
					"ui.button",
					{
						...
						_create : function() {
							...
							var b = this, c = this.options, d = this.type === "checkbox"
									|| this.type === "radio", f = "ui-state-hover"
									+ (!d ? " ui-state-active" : "");
							if (c.label === null)
						...
						_determineButtonType : function() {
							...
							if (this.type === "checkbox"
									|| this.type === "radio") {
								var b = this.element.parents().filter(":last"), c = "label[for="
										+ this.element.attr("id") + "]";
								this.buttonElement = b.find(c);
								if (!this.buttonElement.length) {
									b = b.length ? b.siblings() : this.element
											.siblings();
						...
						_resetButton : function() {
							if (this.type === "input")
								...
								var b = this.buttonElement
										...
										.text(), d = this.options.icons, f = d.primary
										&& d.secondary, e = [];
					...
					K.prototype,
					{
						...
						_optionDatepicker : function(a, b, c) {
							...
							if (e) {
								...
								var h = this._getDateDatepicker(a, true), i = this
										._getMinMaxDate(e, "min"), g = this
										._getMinMaxDate(e, "max");
								F(e.settings, f);
								if (i !== null && f.dateFormat !== A
										&& f.minDate === A)
									e.settings.minDate = this._formatDate(e, i);
								if (g !== null && f.dateFormat !== A
										&& f.maxDate === A)
						...
						_doKeyPress : function(a) {
							...
							if (d.datepicker._get(b, "constrainInput")) {
								b = d.datepicker._possibleChars(d.datepicker
										._get(b, "dateFormat"));
								var c = String
										.fromCharCode(a.charCode == A ? a.keyCode
												: a.charCode);
						...
						_findPos : function(a) {
							for ( var b = this._get(this._getInst(a), "isRTL"); a
									&& (a.type == "hidden" || a.nodeType != 1 || d.expr.filters
											.hidden(a));)
						...
						_get : function(a, b) {
							return a.settings[b] !== A ? a.settings[b]
									: this._defaults[b]
						},
							...
							for ( var L = this._getDefaultDate(a), I = "", D = 0; D < i[0]; D++) {
								for ( var M = "", E = 0; E < i[1]; E++) {
									...
									x += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'
											+ t
											+ '">'
											+ (/all|left/.test(t) && D == 0 ? c ? f
													: n
													: "")
											+ (/all|right/.test(t) && D == 0 ? c ? n
													: f
													: "")
									...
									var B = j ? '<th class="ui-datepicker-week-col">'
									...
									x += "</tbody></table>"
											+ (l ? "</div>"
													+ (i[0] > 0
															&& E == i[1] - 1 ? '<div class="ui-datepicker-row-break"></div>'
															: "")
													: "");
									M += x
								}
						...
						_generateMonthYearHeader : function(a, b, c, e, f, h,
							...
							if (!a.yearshtml) {
								a.yearshtml = "";
								if (h || !l)
									k += '<span class="ui-datepicker-year">'
											+ c + "</span>";
								else {
			...
			.widget(
					"ui.progressbar",
					{
						...
						_refreshValue : function() {
							...
							this.valueDiv.toggle(a > this.min).toggleClass(
									"ui-corner-right", a === this.options.max)
									.width(c.toFixed(0) + "%");
