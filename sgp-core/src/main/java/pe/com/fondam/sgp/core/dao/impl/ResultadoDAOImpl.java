...
public class ResultadoDAOImpl extends JpaBaseDAOImpl implements ResultadoDAO {
	...
	/*
	@Override
	public List<Resultado> findListResultadoByDatoProyectoID(Integer datoPlanOperativoID) {
		String queryString = "from Resultado  where datoPlanOperativo.datoPlanOperativoID = ?";
		Object[] params = new Object[1];
		params[0] = datoPlanOperativoID;
		return super.find(queryString, params);
	}*/
