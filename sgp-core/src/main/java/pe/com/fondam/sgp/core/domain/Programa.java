...
public class Programa implements Serializable {
    ...
    @Transient
    private String descripcionModalidadFinancia;
	...
	public String getDescripcionModalidadFinancia() {
		return descripcionModalidadFinancia;
	}

	public void setDescripcionModalidadFinancia(String descripcionModalidadFinancia) {
		this.descripcionModalidadFinancia = descripcionModalidadFinancia;
	}
