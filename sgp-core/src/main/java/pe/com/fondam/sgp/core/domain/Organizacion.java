...
public class Organizacion implements Serializable {
    ...
    @Transient
    private List<OrgBienTranferido> listOrgBienTranferido;
	...
	public void setListOrgBienTranferido(List<OrgBienTranferido> listOrgBienTranferido) {
		this.listOrgBienTranferido = listOrgBienTranferido;
	}

	public List<OrgBienTranferido> getListOrgBienTranferido() {
